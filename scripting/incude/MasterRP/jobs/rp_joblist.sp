...
//Create Job:
public Action CommandCreateJob(int Client, int Args)
{
...
//Remove Job:
public Action CommandRemoveJob(int Client, int Args)
{
...
//List Jobs:
public Action CommandListJobs(int Client, int Args)
{	
...
//Employ:
public Action CommandEmploy(int Client, int Args)
{
